...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707010288
...
CXXFLAGS="$CLEAR_INTERMEDIATE_CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 "
LDFLAGS="$CLEAR_INTERMEDIATE_LDFLAGS -march=x86-64-v3 "
%configure  --host=x86_64-clr-linux-gnu  --disable-static --disable-openssl --enable-shared --enable-static  --enable-x86-aesni
make  %{?_smp_mflags}
unset CC
popd
%check
...
/VA/usr/lib64/libhogweed.so.6.8
/VA/usr/lib64/libnettle.so.8.8
