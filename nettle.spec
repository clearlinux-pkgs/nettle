...
Version  : 3.10.2
Release  : 75
URL      : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.2.tar.gz
Source0  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.2.tar.gz
Source1  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.2.tar.gz.sig
Source2  : F3599FF828C67298.pkey
...
grep -E '^\[GNUPG:\] (GOODSIG|EXPKEYSIG) F3599FF828C67298' gpg.status
%setup -q -n nettle-3.10.2
cd %{_builddir}/nettle-3.10.2
pushd ..
cp -a nettle-3.10.2 build32
popd
pushd ..
cp -a nettle-3.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1750974319
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libhogweed.so.6.11
/V3/usr/lib64/libnettle.so.8.11
/usr/lib64/libhogweed.so.6
/usr/lib64/libhogweed.so.6.11
/usr/lib64/libnettle.so.8
/usr/lib64/libnettle.so.8.11

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libhogweed.so.6
/usr/lib32/libhogweed.so.6.11
/usr/lib32/libnettle.so.8
/usr/lib32/libnettle.so.8.11
