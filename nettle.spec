...
Source0  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.tar.gz
Source1  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.tar.gz.sig
...
%setup -q -n nettle-3.10
cd %{_builddir}/nettle-3.10
pushd ..
cp -a nettle-3.10 build32
popd
pushd ..
cp -a nettle-3.10 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718602345
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libhogweed.so.6.9
/V3/usr/lib64/libnettle.so.8.9
/usr/lib64/libhogweed.so.6
/usr/lib64/libhogweed.so.6.9
/usr/lib64/libnettle.so.8
/usr/lib64/libnettle.so.8.9
