...
Source0  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.1.tar.gz
Source1  : https://mirrors.kernel.org/gnu/nettle/nettle-3.10.1.tar.gz.sig
...
%setup -q -n nettle-3.10.1
cd %{_builddir}/nettle-3.10.1
pushd ..
cp -a nettle-3.10.1 build32
popd
pushd ..
cp -a nettle-3.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735593155
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libhogweed.so.6.10
/V3/usr/lib64/libnettle.so.8.10
...
/usr/lib32/libhogweed.so.6.10
/usr/lib32/libnettle.so.8
/usr/lib32/libnettle.so.8.10
